...
export const settingsLegacy = (state: SettingsState = initialState, action: Action) => {
  ...
  switch (type) {
    ...
    case 'SETTINGS/SET_LOGIN_STATUS': {
    ...
    case 'SETTINGS/TOGGLE_PIN_LOGIN_ENABLED': {
    ...
    case 'SETTINGS/SET_CUSTOM_TOKENS': {
    ...
    case 'ADD_TOKEN/SET_TOKEN_SETTINGS': {
      const { currencyCode } = data
      return {
        ...state,
        [currencyCode]: data
    ...
    case 'SETTINGS/SET_DENOMINATION_KEY': {
    ...
    case 'SETTINGS/SET_AUTO_LOGOUT_TIME': {
    ...
    case 'SETTINGS/SET_DEFAULT_FIAT': {
    ...
    case 'SETTINGS/SET_MERCHANT_MODE': {
    ...
    case 'SETTINGS/SET_BLUETOOTH_MODE': {
    ...
    case 'SETTINGS/SET_BITCOIN_OVERRIDE_SERVER': {
    ...
    case 'SETTINGS/SET_SETTINGS_LOCK': {
      return {
        ...state,
        changesLocked: data
      }
    ...
    case 'SETTINGS/TOUCH_ID_SETTINGS': {
      if (data) {
        return {
          ...state,
    ...
    case 'SETTINGS/CHANGE_TOUCH_ID_SETTINGS': {
      return {
        ...state,
        isTouchEnabled: data.isTouchEnabled
      }
    ...
    case 'SETTINGS/ADD_CURRENCY_PLUGIN': {
      return currencyPLuginUtil(state, data)
    }

    case 'SETTINGS/SET_ACCOUNT_BALANCE_VISIBILITY': {
      return {
        ...state,
    ...
    case 'SETTINGS/UPDATE_WALLET_FIAT_BALANCE_VISIBILITY': {
      return {
        ...state,
    ...
    case 'PASSWORD_RECOVERY_REMINDER_MODAL/UPDATE_PASSWORD_RECOVERY_REMINDER_MODAL': {
