...
const mapDispatchToProps = (dispatch: Dispatch): {} => ({
  ...
  toggleSelectedWalletListModal: () => dispatch({ type: 'WALLET_LIST_MODAL/TOGGLE_SCAN_TO_WALLET_LIST_MODAL' }),
  toggleScanToWalletListModal: () => dispatch({ type: 'WALLET_LIST_MODAL/TOGGLE_SCAN_TO_WALLET_LIST_MODAL' }),
