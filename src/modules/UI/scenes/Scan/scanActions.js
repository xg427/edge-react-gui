...
export const addressButtonPressed = () => (dispatch) => {
...
export const LEGACY_ADDRESS_MODAL_CONTIUE_BUTTON_PRESSED = PREFIX + 'LEGACY_ADDRESS_MODAL_CONTIUE_BUTTON_PRESSED'
export const legacyAddressModalContinueButtonPressed = () => ({
  type: LEGACY_ADDRESS_MODAL_CONTIUE_BUTTON_PRESSED
})
